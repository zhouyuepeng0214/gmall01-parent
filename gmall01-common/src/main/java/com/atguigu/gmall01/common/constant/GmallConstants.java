package com.atguigu.gmall01.common.constant;
...
public class GmallConstants {
	...
	public static final String KAFKA_TOPIC_USER="GMALL_USER_INFO";
	public static final String KAFKA_TOPIC_ORDER_DETAIL="GMALL_ORDER_DETAIL";

	public static final String ES_INDEX_ALTER="gmall_coupon_alert_0311";
	public static final String ES_INDEX_SALE_DETAIL="gmall0311_sale_detail";
